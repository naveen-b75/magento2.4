...
class CustomerInstall
{
    ...
    public function install($fixtures)
    {
        foreach ($fixtures as $fixture) {
            ...
            foreach ($rows as $row) {
                ...
                $addresses = $this->getAddresses($customerData['address'], true);
    ...
    public function addAddresses($fixtures)
    {
        foreach ($fixtures as $fixture) {
            ...
            foreach ($rows as $row) {
                ...
                $addresses = $this->getAddresses($customerData['address']);
     ...
     * @return mixed
     */
    protected function getAddresses($address, $setDefault = false) {
        $regionData = [
        ...
        $addresses->setRegion($region)
            ->setIsDefaultBilling($setDefault)
            ->setIsDefaultShipping($setDefault);
