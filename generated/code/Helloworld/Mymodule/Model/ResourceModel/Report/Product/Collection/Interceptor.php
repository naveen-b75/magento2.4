<?php
namespace Helloworld\Mymodule\Model\ResourceModel\Report\Product\Collection;

/**
 * Interceptor class for @see \Helloworld\Mymodule\Model\ResourceModel\Report\Product\Collection
 */
class Interceptor extends \Helloworld\Mymodule\Model\ResourceModel\Report\Product\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\Data\Collection\EntityFactory $entityFactory, \Psr\Log\LoggerInterface $logger, \Magento\Framework\Data\Collection\Db\FetchStrategyInterface $fetchStrategy, \Magento\Framework\Event\ManagerInterface $eventManager, \Magento\Sales\Model\ResourceModel\Report $resource, ?\Magento\Framework\DB\Adapter\AdapterInterface $connection = null, string $mainTable = 'sales_order')
    {
        $this->___init();
        parent::__construct($entityFactory, $logger, $fetchStrategy, $eventManager, $resource, $connection, $mainTable);
    }
