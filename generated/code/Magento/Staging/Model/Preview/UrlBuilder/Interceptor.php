...
class Interceptor extends \Magento\Staging\Model\Preview\UrlBuilder implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Framework\UrlInterface $urlBuilder, \Magento\Framework\Url $frontendUrl, ?\Magento\Store\Model\StoreManagerInterface $storeManager = null)
    {
        $this->___init();
        parent::__construct($urlBuilder, $frontendUrl, $storeManager);
    }
