...
class Interceptor extends \Magento\CustomerBalance\Model\Creditmemo\Balance implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\CustomerBalance\Model\BalanceFactory $balanceFactory, \Magento\Store\Model\StoreManagerInterface $storeManager, ?\Magento\Sales\Api\OrderRepositoryInterface $orderRepository = null)
    {
        $this->___init();
        parent::__construct($balanceFactory, $storeManager, $orderRepository);
    }
